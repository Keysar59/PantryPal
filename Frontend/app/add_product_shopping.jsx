...
export default function AddProduct() {
  ...
  console.log("Shopping",params.barcode)
  ...
  const handleAddProduct = async () => {
    ...
    const sendToServer = (productName,quantity) => {
      console.log("Adding %d %s to the shopping list",quantity,productName ); 
    };
      ...
      >
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          ...
          <Pressable
            ...
            onPress={() => router.push(`/scanner?from=${encodeURIComponent("add_product_shopping")}`)}
            >
